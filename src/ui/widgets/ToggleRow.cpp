...
void ToggleSwitch::paintEvent(QPaintEvent*)
{
    ...
    // ── Track ───────────────────────────────────────────────────────────
    p.setPen(Qt::NoPen);
    p.setBrush(QColor(m_checked ? Theme::Color::accentBlue
...
// ToggleRow
// ---------------------------------------------------------------------------
ToggleRow::ToggleRow(const QString& label,
...
void ToggleRow::setChecked(bool checked)   { m_switch->setChecked(checked); }
