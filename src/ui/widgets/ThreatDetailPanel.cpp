...
QString severityHexFromClassification(const QString& classification) {
  ...
  if (c == "SUSPICIOUS")
    return Theme::Color::severityHigh;
  if (c == "ANOMALOUS")
...
QString severityHexFromSeverity(const QString& severity) {
  ...
  if (s == "MEDIUM")
    return Theme::Color::severityMedium;
  if (s == "LOW")
    return Theme::Color::severityLow;
  return Theme::Color::accentBlue;
}
...
ThreatDetailPanel::ThreatDetailPanel(QWidget* parent)
  ...
  setStyleSheet(QString("QFrame#OdyThreatDetail {"
                        "  background-color: %1;"
...
void ThreatDetailPanel::buildUi() {
  ...
  m_closeBtn->setStyleSheet(QString("QPushButton { background: transparent; color: %1;"
  ...
  connect(m_closeBtn, &QPushButton::clicked, this, &ThreatDetailPanel::onCloseClicked);
  ...
  fileCard->setStyleSheet(QString("QFrame#OdyFileCard {"
                                  "  background-color: %1;"
                                  "  border: 1px solid %2;"
                                  "  border-radius: %3px;"
                                  "}")
  ...
  m_iconLabel->setStyleSheet(QString("QLabel { background-color: %1; color: white;"
  ...
  m_severityBadge->setStyleSheet(QString("QLabel { color: white; background-color: %1;"
  ...
  m_tabs->setStyleSheet(
      QString("QTabWidget::pane { border: none; background: transparent; }"
              "QTabBar::tab {"
              ...
              "}")
          .arg(Theme::Color::textSecondary, Theme::Color::textPrimary, Theme::Color::accentBlue));
  ...
  auto buildActionBtn = [this](const QString& label, const QString& bg) -> QPushButton* {
  ...
  m_quarantineBtn =
      buildActionBtn(QString::fromUtf8("\xF0\x9F\x94\x92  Quarantine"), Theme::Color::severityHigh);
  m_deleteBtn =
      buildActionBtn(QString::fromUtf8("\xF0\x9F\x97\x91  Delete"), Theme::Color::severityCritical);
  m_ignoreBtn =
      buildActionBtn(QString::fromUtf8("\xE2\x9C\x95  Ignore"), Theme::Color::accentBlueSoft);
...
QWidget* ThreatDetailPanel::buildOverviewTab() {
  ...
  m_whyFlaggedCard->setStyleSheet(
      QString("QFrame#OdyWhyFlagged {"
              "  background-color: %1;"
              "  border: 1px solid %2;"
              ...
              "}")
          .arg(
              Theme::Color::bgPrimary, Theme::Color::borderSubtle, Theme::Color::severityCritical));
  auto* wfLayout = new QVBoxLayout(m_whyFlaggedCard);
  wfLayout->setContentsMargins(12, 10, 12, 10);
  wfLayout->setSpacing(4);

  auto* wfTitle = new QLabel(QString::fromUtf8("\xE2\x9A\xA0  Why flagged?"), m_whyFlaggedCard);
  wfTitle->setStyleSheet(QString("color: %1; %2")
                             .arg(Theme::Color::severityCritical)
                             .arg(Theme::Type::qss(Theme::Type::Caption, Theme::Type::WeightBold)));
  ...
  m_whyFlaggedLabel->setStyleSheet(QString("color: %1; %2 line-height: 1.55;")
  ...
  m_aiSummaryLabel->setStyleSheet(QString("color: %1; %2 line-height: 1.5;")
                                      .arg(Theme::Color::textPrimary)
                                      .arg(Theme::Type::qss(Theme::Type::Body)));
  ...
  scoreTitle->setStyleSheet(QString("color: %1; font-size: 11px; font-weight: 600;"
                                    " padding-top: 6px;")
  ...
  m_scoreBar->setStyleSheet(
      QString("QProgressBar { background-color: %1; border-radius: 3px; }"
              "QProgressBar::chunk { background-color: %2; border-radius: 3px; }")
          .arg(Theme::Color::bgPrimary, Theme::Color::severityCritical));
  scoreRow->addWidget(m_scoreBar, 1);

  m_scoreText = new QLabel("—", w);
  m_scoreText->setAlignment(Qt::AlignRight);
  m_scoreText->setStyleSheet(QString("color: %1; font-size: 11px; font-weight: 600;"
  ...
  auto* llmTitle = new QLabel(
      QString::fromUtf8("\xF0\x9F\x92\xAC  AI Explanation ") +
          ...
          "; font-size:10px; font-weight: 400;'>(Powered by Ollama)</span>",
      w);
  llmTitle->setStyleSheet(QString("color: %1; font-size: 12px; font-weight: 700; padding-top: 4px;")
                              .arg(Theme::Color::accentBlue));
  ...
  m_overviewLlm->setStyleSheet(
      QString("QPlainTextEdit {"
              "  background-color: %1; color: %2;"
              "  border: 1px solid %3; border-radius: 6px;"
              "  padding: 8px; font-size: 11px;"
              "}")
          .arg(Theme::Color::bgPrimary, Theme::Color::textPrimary, Theme::Color::borderSubtle));
  v->addWidget(m_overviewLlm);

  // Recommended Actions (top 3)
  auto* actTitle = new QLabel("Recommended Actions", w);
  actTitle->setStyleSheet(QString("color: %1; font-size: 11px; font-weight: 600;"
                                  " padding-top: 4px;")
                              .arg(Theme::Color::textSecondary));
  ...
  m_actionsLabel->setStyleSheet(
      QString("color: %1; font-size: 12px; line-height: 1.6;").arg(Theme::Color::textPrimary));
  ...
  hashLabel->setStyleSheet(
      QString("color: %1; font-size: 11px; font-weight: 600;").arg(Theme::Color::textSecondary));
  hashLabel->setMinimumWidth(64);
  hashRow->addWidget(hashLabel);

  m_sha256Compact = new QLabel("—", w);
  m_sha256Compact->setStyleSheet(
      QString("color: %1; font-size: 10px; font-family: monospace;").arg(Theme::Color::textMuted));
...
QWidget* ThreatDetailPanel::buildAiAnalysisTab() {
  ...
  embedHeader->setStyleSheet(
      QString("color: %1; font-size: 12px; font-weight: 700;").arg(Theme::Color::accentBlue));
  v->addWidget(embedHeader);

  m_aiSummaryFull = new QLabel("—", w);
  m_aiSummaryFull->setWordWrap(true);
  m_aiSummaryFull->setStyleSheet(
      QString("color: %1; font-size: 12px; line-height: 1.5;").arg(Theme::Color::textPrimary));
  v->addWidget(m_aiSummaryFull);

  // LLM full explanation
  auto* llmHeader = new QLabel("LLM Explanation", w);
  llmHeader->setStyleSheet(
      QString("color: %1; font-size: 12px; font-weight: 700; padding-top: 6px;")
          .arg(Theme::Color::accentBlue));
  v->addWidget(llmHeader);

  m_llmFull = new QPlainTextEdit(w);
  m_llmFull->setReadOnly(true);
  m_llmFull->setStyleSheet(
      QString("QPlainTextEdit {"
              "  background-color: %1; color: %2;"
              "  border: 1px solid %3; border-radius: 6px;"
  ...
  m_modelInfoLabel->setStyleSheet(
      QString("color: %1; font-size: 10px; padding-top: 4px;").arg(Theme::Color::textMuted));
...
QWidget* ThreatDetailPanel::buildIndicatorsTab() {
  ...
  yaraHeader->setStyleSheet(
      QString("color: %1; font-size: 12px; font-weight: 700; padding-top: 6px;")
          .arg(Theme::Color::accentBlue));
  v->addWidget(yaraHeader);

  m_yaraFamilyLabel = new QLabel("", w);
  m_yaraFamilyLabel->setStyleSheet(
      QString("color: %1; font-size: 11px;").arg(Theme::Color::textSecondary));
...
QWidget* ThreatDetailPanel::buildDetailsTab() {
  ...
  auto rowQss = QString("color: %1; font-size: 11px;").arg(Theme::Color::textPrimary);

  auto headerQss =
      QString("color: %1; font-size: 11px; font-weight: 600;").arg(Theme::Color::textSecondary);

  auto addPair = [v, &rowQss, &headerQss](const QString& title, QLabel*& valueOut) {
  ...
  m_detSha256->setStyleSheet(QString("color: %1; font-size: 10px; font-family: monospace;")
                                 .arg(Theme::Color::textPrimary));
...
void ThreatDetailPanel::populateOverview(const SuspiciousFile& sf) {
  ...
  if (m_whyFlaggedCard) {
    m_whyFlaggedCard->setStyleSheet(
        QString("QFrame#OdyWhyFlagged {"
                ...
                "  border-radius: 8px;"
                "}")
            .arg(Theme::Color::bgPrimary, Theme::Color::borderSubtle, sevHex));
  }
  QString whyHtml;
  if (!sf.keyIndicators.isEmpty()) {
    for (int i = 0; i < qMin(3, int(sf.keyIndicators.size())); ++i) {
      whyHtml += QString::fromUtf8("\xE2\x80\xA2 ") + sf.keyIndicators[i].toHtmlEscaped() + "<br>";
    }
  ...
  // AI Summary (embedded)
  m_aiSummaryLabel->setText(sf.aiSummary.isEmpty() ? "No AI summary available." : sf.aiSummary);

  // Threat Score: prefer confidencePct (0-100), fall back to anomalyScore
  float pct = sf.confidencePct;
  if (pct <= 0.0f && sf.anomalyScore > 0.0f)
    pct = sf.anomalyScore * 100.0f;
  m_scoreBar->setValue(static_cast<int>(pct * 10.0f));
  m_scoreText->setText(QString("%1 / 1.00").arg(sf.anomalyScore, 0, 'f', 2));
  ...
  if (!sf.aiExplanation.isEmpty()) {
    ...
    m_overviewLlm->setPlainText(
        sf.llmAvailable ? "LLM explanation requested — refresh in a moment."
  ...
  if (sf.recommendedActions.isEmpty()) {
    ...
    for (int i = 0; i < qMin(3, int(sf.recommendedActions.size())); ++i) {
      html += QString("\xE2\x80\xA2 %1<br>").arg(sf.recommendedActions[i].toHtmlEscaped());
    }
    m_actionsLabel->setText(html);
  }

  // Hash compact
  m_sha256Compact->setText(sf.sha256.isEmpty() ? "(not computed)" : abbrevHash(sf.sha256));
}

void ThreatDetailPanel::populateAiAnalysis(const SuspiciousFile& sf) {
  m_aiSummaryFull->setText(sf.aiSummary.isEmpty() ? "No AI summary available." : sf.aiSummary);

  if (!sf.aiExplanation.isEmpty()) {
    m_llmFull->setPlainText(sf.aiExplanation);
    m_modelInfoLabel->setText(
        sf.llmAvailable ? QString::fromUtf8("\xE2\x9C\x93 LLM Active \xE2\x80\xA2 "
                                            "Ollama / Llama3")
                        : "LLM cached.");
  } else {
    ...
    m_modelInfoLabel->setText(
        QString::fromUtf8("\xE2\x9C\x97 LLM Unavailable \xE2\x80\xA2 "
...
void ThreatDetailPanel::populateDetails(const SuspiciousFile& sf) {
  ...
  m_detClassification->setText(
      QString("%1 / %2 (score %3, threshold %4)")
          .arg(
              sf.classificationLevel.isEmpty() ? "—" : sf.classificationLevel,
  ...
  m_detSize->setText(QString("%1 (%2 bytes)").arg(prettyBytes(sf.sizeBytes)).arg(sf.sizeBytes));
  m_detModified->setText(sf.lastModified.isValid() ? sf.lastModified.toString(Qt::ISODate) : "—");

  QString sgnText;
  QString sgnColor = Theme::Color::textPrimary;
  switch (sf.signingStatus) {
    case 2:
      sgnText = "Signed (trusted)";
      sgnColor = Theme::Color::severitySafe;
      break;
    case 1:
      sgnText = "Signed (untrusted)";
      sgnColor = Theme::Color::severityMedium;
      break;
    case 0:
      sgnText = "UNSIGNED";
      sgnColor = Theme::Color::severityCritical;
      break;
    default:
      sgnText = "Unknown / not checked";
      break;
  }
  if (!sf.signerId.isEmpty())
    sgnText += " — " + sf.signerId;
  m_detSigning->setText(
      QString("<span style='color:%1;'>%2</span>").arg(sgnColor, sgnText.toHtmlEscaped()));
  ...
  if (sf.reputationFamily.isEmpty()) {
    ...
    if (sf.reputationPrevalence > 0)
      rep += QString(" • seen %1\xC3\x97 on this host").arg(sf.reputationPrevalence);
  }
