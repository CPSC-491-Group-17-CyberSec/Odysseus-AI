...
QString chipQss(bool active) {
  ...
  return QString(
      ...
      .arg(Theme::Color::bgCard, Theme::Color::textSecondary, Theme::Color::borderSubtle)
      .arg(Theme::Type::qss(Theme::Type::Caption, Theme::Type::WeightSemi))
...
FilterBar::FilterBar(QWidget* parent)
  ...
  connect(m_categoryCombo, &QComboBox::currentIndexChanged, this, &FilterBar::filtersChanged);
  ...
  m_search->setStyleSheet(
      QString("QLineEdit {"
          ...
          .arg(Theme::Type::qss(Theme::Type::Caption))
          .arg(Theme::Color::accentBlue));
  connect(m_search, &QLineEdit::textChanged, this, &FilterBar::filtersChanged);
...
QPushButton* FilterBar::makeChip(const QString& label, int severityValue) {
  ...
  connect(b, &QPushButton::clicked, this, &FilterBar::onChipClicked);
  return b;
}
...
int FilterBar::selectedSeverity() const {
  if (m_activeChip < 0 || m_activeChip >= m_chips.size())
    return -1;
