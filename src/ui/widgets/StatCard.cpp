...
void StatCard::setTitle(const QString& s)    { m_titleLabel->setText(s); }
void StatCard::setValue(const QString& s)    { m_valueLabel->setText(s); }
void StatCard::setSubtitle(const QString& s) { m_subtitleLabel->setText(s); }
void StatCard::setIcon(const QString& g)     { m_iconLabel->setText(g); }

void StatCard::applyTone()
{
    QString accent;
    switch (m_tone) {
        case Safe:     accent = Theme::Color::severitySafe;     break;
        case Critical: accent = Theme::Color::severityCritical; break;
        case Warning:  accent = Theme::Color::severityMedium;   break;
        case Info:
        default:        accent = Theme::Color::accentBlue;       break;
    }
