...
DonutChart::DonutChart(QWidget* parent)
  ...
  m_centerVal->setStyleSheet(
      QString("color: %1; font-size: 32px; font-weight: 700; background: transparent;")
  ...
  m_centerLab->setStyleSheet(QString("color: %1; font-size: 11px; background: transparent;")
...
void DonutChart::setCenterValue(const QString& v) {
  m_centerVal->setText(v);
}
void DonutChart::setCenterLabel(const QString& l) {
  m_centerLab->setText(l);
}
